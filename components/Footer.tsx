...
const footerLinks = {
  ...
  about: [
    { name: 'About TFDTRONIC', href: '/about' },
    { name: 'Work With Us', href: '/careers' },
    { name: 'Company Profile', href: '/company' },
  ],
  support: [
    { name: 'Contact', href: '/contact' },
    { name: 'How to Buy at TFDTRONIC', href: '/how-to-buy' },
    { name: 'FAQ', href: '/faq' },
  ],
};
    ...
    <footer className="bg-gradient-to-b from-gray-900 to-black text-gray-300 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            <motion.div
              className="bg-white rounded-2xl p-4 mb-6 inline-block"
            ...
            <div className="flex gap-3">
              {[FacebookIcon, TwitterIcon, InstagramIcon].map((Icon, index) => (
                <motion.a
                  key={index}
                  href="#"
                  className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center group"
          ...
          >
            <h3 className="text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-bold text-lg mb-6">
              Sale
            </h3>
            <ul className="space-y-3">
              {footerLinks.sale.map((link, index) => (
                <motion.li
                  key={link.name}
      ...
      <div className="border-t border-gray-800 relative z-10">
        <motion.div
          className="max-w-7xl mx-auto px-4 py-6 text-center text-sm text-gray-400"
          initial={{ opacity: 0 }}
